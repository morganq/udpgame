...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "dodgeball.py"

        #Name of program
        self.project_name = "Dodgeball"
        ...
        #Auhor of program
        self.author_name = "morganquirk"
        self.author_email = "morganquirk@gmail.com"
        self.copyright = "Copyright (c) 2011 Morgan Quirk"
        ...
        self.extra_datas = ["images", "sounds", "README.txt", "visitor1.ttf"]
